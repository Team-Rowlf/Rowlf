              ...
              {ingredients.map((lineItem) => {
                return (
                  <div
                    ...
                    key={lineItem.ingredient.name}
                  >
                    <input type="checkbox" value={lineItem.ingredient.name} />{' '}
                    (x{lineItem.quantity} {lineItem.measurement}){' '}
                    {lineItem.ingredient.name}
                  </div>
                );
              })}
            </div>
