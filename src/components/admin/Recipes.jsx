				...
				<div className="allrecipes-header">
					...
					<div className="display-info">
						...
						<div className="prev-next">
							<Link
								to={`/admin/recipes?page=${Number(page) - 1}`}
								className={
							...
							<Link
								to={`/admin/recipes?page=${Number(page) + 1}`}
								className={
									page * 25 >= recipeCount ? 'prevNext disabled' : 'prevNext'
								}
								onClick={() => setPage(+page + 1)}
							>
								Next
									...
									<tr key={idx}>
										<td>
											<Link
												...
												to={`/admin/updaterecipe/${recipe.id}`}
											>
												{recipe.id}
											</Link>
										</td>
										...
										<td>
											{recipe.cuisines.length
												? recipe.cuisines
														.map((cuisine) => cuisine.name.toUpperCase())
														.join(', ')
												: 'NO CUISINES'}
										</td>
										<td>
